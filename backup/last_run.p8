...
function init_map()
  ...
  -- Optionally: sprinkle interior walls at random for higherヌ█…level difficulty
  -- for y=3,H-2 do
  --   for x=3,W-2 do
...
-- reverseヌ█…generate a puzzle of N pushes
function generate_puzzle(N)
  ...
  -- sanityヌ█…check using BFS solver
